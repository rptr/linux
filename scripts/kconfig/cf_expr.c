...
// 	if (e1->type != PE_SYMBOL && e1->type != PE_NOT)
// 		return NULL;
// 	if (e2->type != PE_SYMBOL && e2->type != PE_NOT)
// 		return NULL;
// 	
// 	if (e1->type == PE_NOT) {
// 		tmp = e1->left.pexpr;
// 		if (tmp->type != PE_SYMBOL)
// 			return NULL;
// 		fe1 = tmp->left.fexpr;
// 	} else {
// 		fe1 = e1->left.fexpr;
// 	}
// 	if (e2->type == PE_NOT) {
// 		if (e2->left.pexpr->type != PE_SYMBOL)
// 			return NULL;
// 		fe2 = e2->left.pexpr->left.fexpr;
// 	} else {
// 		fe2 = e2->left.fexpr;
// 	}
}
