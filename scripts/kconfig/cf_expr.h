...
#define fexl_list_for_each(node, list) fexpr_list_for_each(node, list)

#define pexpr_list_for_each(node, list) fexpr_list_for_each(node, list)

#define sdv_list_for_each(node, list) fexpr_list_for_each(node, list)

#define sfix_list_for_each(node, list) fexpr_list_for_each(node, list)

#define sfl_list_for_each(node, list) fexpr_list_for_each(node, list)

#define sym_list_for_each(node, list) fexpr_list_for_each(node, list)

#define defm_list_for_each(node, list) fexpr_list_for_each(node, list)
